 ...
 */
var jquery, underscore, backbone, src_js_models_Example, models, text, text_src_js_views_home_examplehtml, src_js_components_Table, components, views, backbonecontroller, src_js_controllers_HomeController, controllers, routers, app;
...
src_js_models_Example = function (Backbone, _) {
...
text_src_js_views_home_examplehtml = '<table>\n    <thead>\n        <tr>\n            <th>Colors</th>\n        </tr>\n    </thead>\n    <tbody>\n        <% _.each(items, function (c) { %>\n        <tr>\n            <td>\n                <%= c %>\n            </td>\n        </tr>\n        <% }); %>\n    </tbody>\n</table>\n\n';
src_js_components_Table = function (Backbone, _, tplExample) {
  ...
  // Return component
  return Table;
}(backbone, underscore, text_src_js_views_home_examplehtml);
components = function (Table) {
  /**
   * Return all components
   */
  return { 'Table': Table };
}(src_js_components_Table);
...
(function (root, factory) {
  ...
  if (true) {
    backbonecontroller = function (_, Backbone, exports) {
      // Export global even in AMD case in case this script is loaded with
      // others that may still expect a global Backbone.
    ...
    var _ = underscore, Backbone = backbone;
    module.exports = factory(root, exports, _, Backbone);  // Finally, as a browser global.
  } else {
  ...
  var bindRoutes = function (Router) {
      ...
      var self = this, args = _.toArray(arguments), url = args[0], methodName = this.routes[url], params = args.slice(1), triggerRouteAndAfterRoute = function () {
      ...
      if (cachedController && cachedController !== this && typeof cachedController.remove === 'function') {
      ...
      if (beforeRouteResult === false || beforeRouteResult === null)
        return this;
...
src_js_controllers_HomeController = function (Backbone, _, Models, Views, Controller) {
...
}(backbone, underscore, models, views, backbonecontroller);
controllers = function (Home) {
  /**
   * Return all controllers
   */
  return { 'HomeController': Home };
}(src_js_controllers_HomeController);
routers = function (Backbone, Controllers) {
  /**
...
app = function ($, _, Backbone, Router) {
  //
  // GENERAL
  //
  // Public API
  window.app = { VERSION: '0.1' };  //
                                    ...
                                    //
}(jquery, underscore, backbone, routers);
}());